package com.demo.apiQuartz.service.impl;

import com.demo.apiBatch.domain.BatchJobInfo;
import com.demo.apiQuartz.component.QuartzBatchAdapter;
import com.demo.apiQuartz.service.util.QuartzJobScheduleCreator;
import com.demo.apiBatch.domain.dto.BatchJobInfoDTO;
import com.demo.apiBatch.repository.BatchRepository;
import com.demo.apiQuartz.service.QuartzService;
import com.demo.apiQuartz.service.util.QuartzServiceUtil;
...
public class QuartzServiceImpl implements QuartzService {
    ...
    public int assignSchedulesInDB() {
        ...
        List<BatchJobInfo> jobInfoList = batchRepository.findAll();
        ...
        if (!jobInfoList.isEmpty()) {
            ...
            for (BatchJobInfo jobInfo : jobInfoList) {
                try {
...
//        }
    ...
    @Override
    public  List<BatchJobInfo> readJobInfoList(){
     ...
     */
    @Override
    public int addScheduledJob(BatchJobInfo jobInfo) {
        try {
            ...
            List<BatchJobInfo> dbJobInfoList = batchRepository.findByJobNameAndJobChannel(jobInfo.getJobName(), jobInfo.getJobChannel());
    ...
    @Override
    public int updateScheduledJob(BatchJobInfo jobInfo) {
        try {
            Scheduler scheduler = schedulerFactoryBean.getScheduler();
            try {
                JobDetail jobDetail = quartzServiceUtil.createJobDetail(jobInfo); // Make Job Detail

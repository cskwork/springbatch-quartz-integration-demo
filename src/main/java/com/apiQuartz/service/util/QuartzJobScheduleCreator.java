...
@Slf4j
@Component
public class QuartzJobScheduleCreator {
     ...
     * @param context   Spring application configuration.
     ...
     */
    public SimpleTrigger createSimpleTrigger(String triggerName, String triggerGroup, Date startTime, Long repeatTime, int misFireInstruction) {
        SimpleTriggerFactoryBean factoryBean = new SimpleTriggerFactoryBean();
        factoryBean.setName(triggerName);
        factoryBean.setName(triggerGroup);
